 ...
 * This simple implementation demonstrates the use of jsoup to convert HTML input to lightly-formatted
 * plain-text. 
 * <p/>
 *
 * @author Eolya Consulting - http://www.eolya.fr/
 */
public class HtmlToPlaintTextSimple implements IHtmlFormater {
